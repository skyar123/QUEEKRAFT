export const ZINES = {
    ...
    'spec_anxious_distress': { title: 'Anxious Distress Specifier', image: '/images/zine_herbal.png', content: '<h3>Anxious Distress Specifier</h3><p>Applies to MDD, Bipolar I/II, PDD, PMDD, DMDD. Criteria: 2+ of — feeling keyed up or tense; feeling unusually restless; difficulty concentrating because of worry; fear something awful may happen; feeling individual might lose control of themselves.</p><p>Severity: Mild (2 symptoms), Moderate (3), Moderate-Severe (4-5), Severe (4-5 with motor agitation).</p><p>Exam tip: Most common specifier in depressive and bipolar disorders. Increases suicide risk and predicts slower recovery. Always assess and document severity.</p>' },
    'spec_mixed_features': { title: 'Mixed Features Specifier', image: '/images/zine_poetry.png', content: '<h3>Mixed Features Specifier</h3><p>A) Manic/Hypomanic WITH mixed features: 3+ depressive symptoms during most days of episode — prominent dysphoria or depressed mood; diminished interest or pleasure; psychomotor retardation; fatigue; worthlessness or excessive guilt; recurrent thoughts of death or suicidal ideation. Not attributable to substances.</p><p>B) MDE WITH mixed features: 3+ manic/hypomanic symptoms — elevated or expansive mood; grandiosity or inflated self-esteem; more talkative than usual or pressured speech; flight of ideas or racing thoughts; increased energy or goal-directed activity; decreased need for sleep; involvement in activities with high potential for harmful consequences. Full manic criteria NOT met. Not attributable to substances.</p><p>Exam tip: Mixed features greatly increase suicide risk — always assess when present. Mixed features in MDE may indicate bipolar spectrum; antidepressants alone may worsen. This changes treatment planning significantly.</p>' },
    'spec_rapid_cycling': { title: 'Rapid Cycling Specifier', image: '/images/zine_punk.png', content: '<h3>Rapid Cycling Specifier</h3><p>Applies to Bipolar I and Bipolar II only. Definition: at least 4 mood episodes in the previous 12 months meeting criteria for manic, hypomanic, or major depressive episode. Episodes demarcated by full or partial remission of at least 2 months OR by a switch to an episode of opposite polarity.</p><p>Note: the rapid cycling specifier can be applied whether or not episodes are separated by full remissions. Rapid cycling is a course specifier — the person can transition in and out of rapid cycling status.</p><p>Exam tip: Associated with worse prognosis, more depressive burden, and poorer response to lithium monotherapy. Lamotrigine and valproate are preferred. Screen for thyroid dysfunction and substance use — both can trigger rapid cycling.</p>' },
    'spec_melancholic': { title: 'Melancholic Features Specifier', image: '/images/zine_appalachia.png', content: '<h3>Melancholic Features Specifier</h3><p>Applies to current or most recent major depressive episode. Requires EITHER: anhedonia (loss of pleasure in all or almost all activities) OR lack of mood reactivity (mood does not improve at all, even temporarily, in response to positive events).</p><p>PLUS 3+ of: distinct quality of depressed mood (profoundly different from ordinary sadness); depression regularly worse in the morning; early morning awakening (at least 2 hours before usual); marked psychomotor agitation or retardation; significant anorexia or weight loss; excessive or inappropriate guilt (may be delusional).</p><p>Exam tip: Suggests severe, biologically-driven depression. Mood is NOT reactive (key differential from atypical). Often responds well to somatic treatments including ECT and tricyclic antidepressants. Psychomotor changes and early-morning awakening are the most diagnostically specific features.</p>' },
    'spec_atypical': { title: 'Atypical Features Specifier', image: '/images/zine_music.png', content: '<h3>Atypical Features Specifier</h3><p>Applies to current or most recent MDE or PDD. Cardinal feature: MOOD REACTIVITY — mood brightens in response to actual or potential positive events. Cannot meet criteria for melancholic or catatonic specifier.</p><p>PLUS 2+ of: significant weight gain or increased appetite; hypersomnia; leaden paralysis (heavy, leaden feelings in arms or legs); long-standing pattern of interpersonal rejection sensitivity causing significant social or occupational impairment.</p><p>Exam tip: Most common MDD subtype. Patients CAN feel better temporarily — unlike melancholic. More common in women, Bipolar II, and those with comorbid anxiety. MAOIs historically more effective than TCAs; SSRIs are current first-line. Rejection sensitivity persists even between episodes — often the most impairing feature.</p>' },
    'spec_psychotic_feat': { title: 'Psychotic Features Specifier', image: '/images/zine_history.png', content: '<h3>Psychotic Features Specifier</h3><p>Applies to manic episodes, major depressive episodes. Presence of delusions AND/OR hallucinations.</p><p>Mood-congruent: content consistent with predominant mood theme. In depression — delusions of inadequacy, guilt, disease, death, nihilism, or deserved punishment. In mania — delusions of inflated worth, power, knowledge, identity, or special relationship to deity.</p><p>Mood-incongruent: content NOT consistent with mood polarity, OR content that cannot be classified as mood-congruent (e.g., persecutory delusions without obvious connection to mood).</p><p>Exam tip: Psychotic features require antipsychotic treatment in addition to mood agents. Mood-incongruent psychosis carries worse prognosis. KEY DIFFERENTIAL: In schizophrenia/schizoaffective, psychotic symptoms occur INDEPENDENTLY of mood — at least 2 weeks without prominent mood symptoms. In psychotic depression, psychosis only occurs during mood episodes.</p>' },
    'spec_peripartum': { title: 'Peripartum Onset Specifier', image: '/images/zine_witch.png', content: '<h3>Peripartum Onset Specifier</h3><p>Applies to current or most recent MDE (in MDD, Bipolar I, or Bipolar II), manic episode, or hypomanic episode. Onset: during pregnancy OR in the 4 weeks following delivery.</p><p>Critical note: Up to 50% of postpartum major depressive episodes actually begin PRIOR to delivery — onset is peripartum, not exclusively postpartum.</p><p>Distinctions: Postpartum blues (2-3 days post-delivery, mild, self-resolving, affects 50-80%) is NOT a DSM diagnosis. Postpartum psychosis (a psychiatric emergency, onset within 2 weeks post-delivery, often bipolar-spectrum, affects 1-2/1000) requires immediate hospitalization.</p><p>Exam tip: Use the Edinburgh Postnatal Depression Scale (EPDS) for universal screening. Score of 13+ indicates probable depression. SSRIs are generally safe during breastfeeding; sertraline has the lowest breast milk transfer. Peripartum onset predicts higher risk with subsequent pregnancies — discuss proactively.</p>' },
    'spec_seasonal': { title: 'Seasonal Pattern Specifier', image: '/images/zine_appalachia.png', content: '<h3>Seasonal Pattern Specifier</h3><p>Applies to recurrent MDD, Bipolar I, Bipolar II. Requirements: Regular temporal relationship between onset of mood episodes and a particular time of year, NOT related to obvious seasonally related psychosocial stressors. Full remissions or polarity switches also occur at a characteristic time of year.</p><p>In the LAST 2 YEARS: 2+ mood episodes demonstrating the temporal seasonal relationship, AND no non-seasonal episodes during that period. Over the lifetime: seasonal episodes substantially outnumber non-seasonal episodes. Most common: depressive episodes fall/winter, remission spring/summer.</p><p>Exam tip: Light therapy (10,000 lux lightbox, 20-30 minutes each morning, beginning in early fall) is FIRST-LINE for seasonal MDD. Bupropion XL is the only FDA-approved medication specifically indicated for prevention of seasonal depressive episodes. Consistent sleep schedule matters — circadian disruption drives seasonal pattern.</p>' },
    'spec_catatonia': { title: 'Catatonia Specifier', image: '/images/zine_diy.png', content: '<h3>Catatonia Specifier</h3><p>Can be applied across multiple disorders: schizophrenia, other psychotic disorders, bipolar and depressive disorders, ASD, medical conditions. Also exists as a standalone diagnosis.</p><p>Requires 3+ of 12 features: stupor; catalepsy; waxy flexibility; mutism; negativism; posturing; mannerism; stereotypy; agitation not influenced by external stimuli; grimacing; echolalia; echopraxia.</p><p>Exam tip: Catatonia is a MEDICAL EMERGENCY when severe — can cause dehydration, DVT, aspiration pneumonia. First-line: lorazepam (benzodiazepine challenge). ECT is effective for benzodiazepine-refractory catatonia. DO NOT administer antipsychotics first — they can precipitate or worsen malignant catatonia (similar to NMS).</p>' },
    'dsm_pmdd_dmdd': { title: 'PMDD & DMDD', image: '/images/zine_herbal.png', content: '<h3>PMDD & DMDD</h3><p>PREMENSTRUAL DYSPHORIC DISORDER: In the final week before menses onset, most cycles, with improvement beginning within a few days after menses onset. 5+ symptoms including at least 1 of: marked affective lability; marked irritability or anger; marked depressed mood; marked anxiety or tension. Plus any of: decreased interest; difficulty concentrating; lethargy; appetite change; sleep change; sense of being overwhelmed; physical symptoms. Must confirm with prospective daily ratings for at least 2 symptomatic cycles. Treatment: SSRIs (luteal phase dosing or continuous), OCP with drospirenone.</p><p>DISRUPTIVE MOOD DYSREGULATION DISORDER: For children 6-18 years. Severe recurrent temper outbursts grossly disproportionate in intensity or duration to the provocation, at least 3 times per week. Persistently irritable or angry mood between outbursts, most of the day, nearly every day. Symptoms in 2+ settings. Onset before age 10; not diagnosed before age 6 or after 18. Created in DSM-5 to reduce overdiagnosis of pediatric bipolar disorder. Key differential: DMDD features CHRONIC irritability; Bipolar features EPISODIC mood changes.</p>' },
    'dsm_sexual_dysfunctions': { title: 'Sexual Dysfunctions (DSM-5-TR)', image: '/images/zine_queer.png', content: '<h3>Sexual Dysfunctions (DSM-5-TR)</h3><p>Major categories: Delayed Ejaculation; Erectile Disorder; Female Orgasmic Disorder; Female Sexual Interest/Arousal Disorder (FSIAD); Genito-Pelvic Pain/Penetration Disorder (GPPPD); Male Hypoactive Sexual Desire Disorder; Premature (Early) Ejaculation; Substance/Medication-Induced Sexual Dysfunction; Other Specified and Unspecified.</p><p>For any diagnosis: most occasions (75-100% of time), persistent (6+ months minimum), not explained by a non-sexual mental disorder, relationship distress, partner violence, or medical/substance cause. Specifiers: Lifelong vs. Acquired; Generalized vs. Situational. Severity: Mild, Moderate, Severe.</p><p>Affirming clinical note: These diagnoses use sex-assigned-at-birth language throughout — clinical judgment and individualized language are required with transgender and intersex patients. Sexual dysfunction is often a side effect of SSRIs and antipsychotics — always assess and discuss. Affirming approach to sexuality is foundational.</p>' },
    'dsm_vcodes': { title: 'V-Codes: Other Conditions (DSM-5-TR)', image: '/images/zine_abolition.png', content: '<h3>V-Codes: Other Conditions That May Be a Focus of Clinical Attention</h3><p>These are NOT mental disorders but are frequently the primary focus of LCSW work. Major categories: Relational Problems; Child Maltreatment and Neglect; Adult Maltreatment and Neglect; Educational and Occupational Problems; Housing and Economic Problems (homelessness, inadequate housing, lack of adequate food or safe drinking water, extreme poverty); Other Psychosocial, Personal, Environmental Circumstances (religious or spiritual problem, phase of life problem, bereavement, acculturation difficulty, social exclusion or rejection); Problems Related to Crime; Problems Related to Other Circumstances of Personal History.</p><p>LCSW exam tip: V-codes can be listed as the PRINCIPAL REASON for the clinical encounter even when NO mental disorder is present. Know the categories — they represent the social determinants of mental health that LCSW practice addresses directly.</p>' },
    'dsm_cultural': { title: 'Cultural Formulation & CFI', image: '/images/zine_history.png', content: '<h3>Cultural Formulation & CFI</h3><p>The DSM-5-TR Cultural Formulation Interview (CFI) — 16-item structured interview assessing: (1) Cultural definition of the problem; (2) Cultural perceptions of cause, context, and support; (3) Cultural factors affecting self-coping and past help seeking; (4) Cultural factors affecting current help seeking.</p><p>Cultural Concepts of Distress: Ataque de nervios (Latin American — sudden distress, dissociation, out-of-control behavior after acute stress); Dhat syndrome (South Asian — anxiety about semen loss); Ghost illness (various Indigenous populations); Khyal cap (Cambodian — wind attacks, panic-like symptoms); Kufungisisa (Zimbabwe — thinking too much); Hikikomori (Japanese — acute social withdrawal).</p><p>LCSW exam tip: Cultural formulation is not a checklist — it is a stance of curiosity and humility. A diagnosis made without cultural context is incomplete. The CFI is the tool; cultural humility is the orientation.</p>' },
    'dsm_biopsychosocial': { title: 'Biopsychosocial-Spiritual Model', image: '/images/zine_mutual_aid.png', content: '<h3>Biopsychosocial-Spiritual Model</h3><p>BIOLOGICAL: genetics and family history, neurobiological factors, medical conditions and medications, substance use history, developmental and perinatal history.</p><p>PSYCHOLOGICAL: cognitive patterns (schemas, core beliefs, cognitive distortions), emotional regulation capacity, defense mechanisms, coping strategies, trauma history, attachment style, ego strength.</p><p>SOCIAL: family system and dynamics, social support network, socioeconomic status, employment and housing stability, cultural identity, immigration status, systemic discrimination and oppression, minority stress, access to resources.</p><p>SPIRITUAL: sense of meaning and purpose, religious or spiritual beliefs and practices, existential concerns, community belonging, hope and transcendence.</p><p>LCSW principle: The DSM gives you the biological-psychological shorthand. The social and spiritual dimensions — and the SYSTEMS that shape them — belong to the clinical formulation. Minority stress is a SOCIAL determinant, not a biological one. Advocacy IS clinical work.</p>' },
    'dsm_differential': { title: 'Differential Diagnosis: LCSW Keys', image: '/images/zine_punk.png', content: '<h3>Differential Diagnosis: LCSW Keys</h3><p>Core rules: (1) Always rule out medical conditions first — hypothyroidism mimics depression; hyperthyroidism mimics anxiety; B12 deficiency mimics psychosis; temporal lobe epilepsy mimics dissociation. (2) Rule out substance/medication effects. (3) Rule out another mental disorder explaining symptoms better.</p><p>KEY DIFFERENTIALS: MDD vs. Bipolar I/II — ALWAYS ask about any history of mania or hypomania; missing a manic episode and treating with antidepressants alone can trigger rapid cycling or mixed state. PTSD vs. Adjustment Disorder — was the stressor traumatic? Duration? GAD vs. OCD — GAD worry is ego-syntonic and about real-life topics; OCD obsessions are ego-dystonic and feel alien/intrusive. BPD vs. Bipolar II — BPD has chronic, pervasive instability; BPD has identity disturbance, not mood cycling. Schizophrenia vs. Schizoaffective — are there 2+ weeks of psychosis WITHOUT prominent mood symptoms? ADHD vs. PTSD — both cause attention problems; PTSD features hypervigilance, avoidance, and trauma history.</p>' }
};
...
export const QUESTS = {
    ...
    'clinical_placement': {
        id: 'clinical_placement',
        title: 'Clinical Placement',
        giver: 'echo_peer_sol',
        summary: 'Reach depth 7 — each floor is a clinical encounter.',
        detail: 'Sol needs you to complete your field hours. Every floor deeper is a skill-building moment. Assess. Formulate. Intervene. Reach depth 7.',
        goal: { type: 'reach_depth', target: 7 },
        reward: { permanentDamage: 1, scrap: 20, message: 'Clinical hours complete. Your formulation is sharper. +1 permanent damage, +20 scrap.' },
        acceptDialog: "Seven floors deep. You learn by doing. Assess, formulate, intervene. I\'ll be here when you\'re done.",
        pendingDialog: "Keep going. Clinical hours build through repetition. Reach depth 7.",
        completeDialog: "Seven floors logged. You\'re sharper now. That\'s what training does. Take this — it\'s earned."
    }
};
